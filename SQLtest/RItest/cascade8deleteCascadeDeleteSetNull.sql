...
create table grandchild (id integer not null primary key, parent_id integer references child ON DELETE SET NULL, name varchar(10));
...
-- EXPECT succeed & children 10-30 parent=NULL: Plus grandchild 100 exists, so set its parent=NULL
